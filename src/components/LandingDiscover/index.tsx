...
const LandingDiscover = (props: Props) => {
  return (
    <div className="flex flex-col lg:flex-row ">
      <img src={images.landingDiscoverImg} className="lg:w-[75%] lg:h-full max-h-[70vh] w-[90%]" />
      <div className=" flex flex-col items-start justify-evenly ">
        <div className="">
          ...
          <div className="border flex flex-row items-center justify-between w-[90%] ml-4 lg:w-[50%] bg-black py-1 lg:py-2 px-5 rounded-2xl cursor-pointer mt-5 active:opacity-50">

  ...
  return (
    <div className="h-[50vh] sm:h-[65vh] md:h-[75vh] lg:h-[85vh] xl:h-[95vh] 2xl:h-screen flex flex-col items-start justify-end relative bg-center w-full">
      ...
      <AnimatedImage
        key={activeIndex}
        src={sliderImages[activeIndex]?.image}
        containerClassName="absolute h-full w-full z-[-1]"
        className="w-full h-full"
      />
      <LeftToRightAnimation delay={0.6} className="flex flex-row mb-10 items-center justify-start sm:w-auto px-8 lg:px-20">
        <img
          src={images.Arrow}
      ...
      <div className="flex flex-col items-start md:flex-row md:items-end justify-between px-2 md:px-8 lg:px-16 pb-4 md:pb-10">
        <LeftToRightAnimation className="text-white text-sm md:text-2xl lg:text-4xl xl:text-6xl 2xl:text-8xl font-bold w-full text-center md:text-start  md:w-[50%] text-wrap ">
          Experience the Art of Grooming at TRU Barber
        </LeftToRightAnimation>
        <RightToLeftAnimation className="text-white text-sm md:text-sm w-full text-center md:text-start px-2 md:w-[60%] lg:w-[42%] xl:w-[35%] 2xl:w-[25%] text-wrap">
      ...
      >
        <TopToBottomAnimation className="text-white text-sm md:text-xl font-light cursor-pointer">
          Instagram
        </TopToBottomAnimation>
        <LeftToRightAnimation className="text-white text-sm md:text-xl font-light cursor-pointer px-4 sm:px-10">
          Facebook
        </LeftToRightAnimation>
        <RightToLeftAnimation className="text-white text-sm md:text-xl font-light cursor-pointer">
          Twitter
        </RightToLeftAnimation>
      </div>
    </div>

...
const SideBar = ({ showSidebar }: Props) => {
  ...
  return (
    <div
      className={`sticky max-h-screen relative top-0 left-0  bg-black py-10 transition-all duration-300
      ${
        showSidebar
          ? "flex w-64 md:w-[37%] lg:w-[25%] xl:w-[20%] 2xl:w-[17%]"
          : "hidden"
      } 
      flex-col z-50`}
    >
      ...
      <div className="w-full h-px bg-hoverGray my-10" />

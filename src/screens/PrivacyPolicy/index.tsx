...
const PrivacyPolicy = (props: Props) => {
  return (
    <div className="bg-black p-6 md:p-10 lg:p-20 text-gray-800 2-full">
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 md:p-10 rounded-md shadow-md space-y-6">
        ...
        <section>
          ...
          <p>
            The Application collects your device’s location to provide features like personalized content, relevant recommendations, and location-based services. Aggregated and anonymized location data helps the Service Provider to analyze user behavior, identify trends, and improve the Application’s performance.
          </p>
        </section>
